...
ALTER TABLE user ADD FOREIGN KEY id_idxfk (id) REFERENCES auth_twitter (twitter_user_id);

ALTER TABLE purchase ADD FOREIGN KEY user_idxfk (user) REFERENCES user (id);
...
ALTER TABLE action ADD FOREIGN KEY user_idxfk_1 (user) REFERENCES user (id);

ALTER TABLE auth_password ADD FOREIGN KEY user_idxfk_2 (user) REFERENCES user (id);
